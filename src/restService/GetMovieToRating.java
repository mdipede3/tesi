...
@Path("/movieToRating")
public class GetMovieToRating {
	
	@Context ServletContext servletContext;
	@GET
	@Produces({MediaType.APPLICATION_JSON, "text/json"})
	@Path("/getMovieToRating")
	public String getMovieToRating (@QueryParam("userID") String userID) throws Exception 
	{
		...
		movieURI = asController.getMovieToRatingByPopularMovies(user_id);
